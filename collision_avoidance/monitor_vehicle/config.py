...
YOLO_FAR_UNRELIABLE_RAW_MIN_M = 20.0
YOLO_FAR_UNRELIABLE_MAX_BBOX_WIDTH_PX = 85
YOLO_FAR_UNRELIABLE_MAX_BBOX_HEIGHT_PX = 60
YOLO_FAR_UNRELIABLE_MAX_BBOX_AREA_PX = 4500

TRACK_STALE_FRAMES = 60
DETECTION_HOLD_FRAMES = 6
DRAW_HELD_DETECTIONS = False
HELD_SUPPRESS_IOU_THRESHOLD = 0.5
